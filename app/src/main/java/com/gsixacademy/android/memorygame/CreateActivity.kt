...
import com.gsixacademy.android.memorygame.utils.*
...
class CreateActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val READ_EXTERNAL_PHOTOS_CODE = 213
            ...
            db.collection("games").document(customGameName).get().addOnSuccessListener { document ->
              if (document != null &&  document.data != null ){
                 AlertDialog.Builder(this)
                     .setTitle("Name taken")
                     .setMessage("A game already exsists with the name '$customGameName'. Please choose another")
                ...
                Log.e (TAG, "Encountered error while saving memory game", exeption)
    ...
    private fun getImageByteArray(photoUri: Uri): ByteArray {
        ...
        Log.i (TAG, "Scaled width ${scaledBitmap.width} and hight ${scaledBitmap.height}")
